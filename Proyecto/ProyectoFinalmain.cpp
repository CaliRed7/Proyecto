...
int main()
{
	...
	hipoTexture = Texture("Textures/HiccupTeen.png");
	hipoTexture.LoadTextureA();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Personaje - Link
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(3.9f, 0.225f, -3.9f));
		...
		//model = glm::rotate(model, 120 * toRadians, glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion11()), glm::vec3(.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		Dado8.RenderModel();
		////////////////////ILUMINACION/////////////////////////////////////////
		//lampara 1
		...
		//// //Dirigible
		//model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(75.0f, 18.0f, -75.0f));		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		////model = glm::rotate(model, -rot * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//modelaux = model;
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//// //Dirigible
		//model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(-10.0f, 18.0f, -75.0f));		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		////model = glm::rotate(model, -rot * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//modelaux = model;
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//// //Dirigible
		//model = glm::mat4(1.0);
		//model = glm::translate(model, glm::vec3(-10.0f, 18.0f, 25.0f));		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		////model = glm::rotate(model, -rot * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::rotate(model, 180 * toRadians, glm::vec3(0.0f, 1.0f, 0.0f));
		//modelaux = model;
		//glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
